...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="Index_top_1">
			...
			<div class="header" style="background:url('<%=request.getContextPath() %>/static/front/images/fw.jpg') no-repeat center top;">
			...
			<div class="y_index_nyi">
				<div class="y_index_y4">
					<div class="y_indexi_2">
						<div class="y_indexi_2_img">
							<img src="<%=request.getContextPath() %>/static/front/images/5dyx.png" style="width: 100%;" />
						</div>
					</div>
				</div>
				<div class="cls"></div>
