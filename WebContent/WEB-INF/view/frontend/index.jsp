	...
	<body>
		...
		<div class="Index_top_1">
				...
				<div class="Index_top_1_1_2">
					<div class="Index_top_1_2_1">
						<ul>
							...
							<li class="off">
								<a href="<%=request.getContextPath() %>/article"><img src="<%=request.getContextPath() %>/static/front/images/search.png" style="width: 18px;" />案例&nbsp;<i style="font-weight: 400;font-family:AvantGarde md bt"><b>CASES</b></i></a>
							</li>
							<li class="off">
			...
			<div class="header">
				...
				<script type="text/javascript" src="<%=request.getContextPath() %>/static/front/js/jquery-1.11.1.min.js"></script>
				<script type="text/javascript" src="<%=request.getContextPath() %>/static/front/js/top_jquery.jslides.js"></script>
				<!-- 代码 开始 -->
				<div id="full-screen-slider">
					<ul id="slides">
						<li style="background:url('<%=request.getContextPath() %>/static/front/uploadfile/g_1.jpg') no-repeat center top"></li>
						<li style="background:url('<%=request.getContextPath() %>/static/front/uploadfile/g_2.jpg') no-repeat center top"></li>
						<li style="background:url('<%=request.getContextPath() %>/static/front/uploadfile/g_3.jpg') no-repeat center top"></li>
						<li style="background:url('<%=request.getContextPath() %>/static/front/uploadfile/g_4.jpg') no-repeat center top"></li>
		...
		<div class="genius_index2">
			...
			<div class="genius_index2_2">
				<li>我们都服务过什么？ What we have served?</li>
			</div>
		</div>
