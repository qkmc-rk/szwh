...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="topcall">
			<div id="callpic">
				<img src="<%=request.getContextPath() %>/static/front/images/call.png" style="width:15px;"></img><span>&nbsp;<b>联系电话:</b><i>028-<b style="font-size:20px">85120685</b></i></span>
 			</div>
		</div>
		<!--/*头部加入收藏*/-->
		<div class="Index_top_1">
			...
			<div class="header" style="background:url('<%=request.getContextPath() %>/static/front/images/hzhd.jpg') no-repeat center top;">
